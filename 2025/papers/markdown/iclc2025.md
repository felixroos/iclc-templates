...
author:
  ...
  - name: Raphaël Maurice Forment
    affiliation: Université Jean Monnet (Saint-Étienne, France)
...
The project is still in an early phase and comes with a set of limitations. While it is possible to change So far, it is not possible to schedule sample accurate events from the outside, which is a requirement of Strudel's audio engine.
