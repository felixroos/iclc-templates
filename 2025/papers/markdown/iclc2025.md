...
The compiler's sole responsibility is to pass the correct register names and constant values to the compile function.
...
This runtime should also handle code update and hot-reloading, which is an essential feature for a live coding system.
